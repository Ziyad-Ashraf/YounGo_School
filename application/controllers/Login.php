...
class Login extends CI_Controller
{
    ...
    private function youngo_store_public_auth_language()
    {
        ...
        if (in_array($language, array('arabic', 'english'), true)) {
            $this->session->set_userdata('youngo_public_auth_language', $language);
        }
    }
    ...
    public function index()
    {
        ...
        $page_data['page_title'] = $this->youngo_public_auth_page_title('login', 'Login');
    ...
    function new_login_confirmation($param1 = ""){
        ...
        $page_data['page_title'] = $this->youngo_public_auth_page_title('login_confirmation', 'Login confirmation');
        $this->load->view('frontend/' . get_frontend_settings('theme') . '/index', $page_data);
    }
    ...
    public function forgot_password_request()
    {
        ...
        $page_data['page_title'] = $this->youngo_public_auth_page_title('forgot_password', 'Forgot password');
        $this->load->view('frontend/' . get_frontend_settings('theme') . '/index', $page_data);
    }
    ...
    function change_password($verification_code = ""){
        ...
        $page_data['page_title'] = $this->youngo_public_auth_page_title('change_password', 'Change password');
        $this->load->view('frontend/' . get_frontend_settings('theme') . '/index', $page_data);
