...
?>
<?php $youtube_embed_url = youtube_embed_url($course_details['video_url'] ?? ''); ?>

<link rel="stylesheet" href="<?php echo base_url(); ?>assets/global/plyr/plyr.css">

<?php if (strtolower($provider) == 'youtube'): ?>
    <div class="plyr__video-embed" id="player">
        <iframe height="500" src="<?php echo htmlspecialchars($youtube_embed_url . '?origin=https://plyr.io&amp;iv_load_policy=3&amp;modestbranding=1&amp;playsinline=1&amp;showinfo=0&amp;rel=0&amp;enablejsapi=1', ENT_QUOTES, 'UTF-8'); ?>" allowfullscreen allowtransparency allow="autoplay"></iframe>
    </div>
...
<?php else: ?>
    <video poster="<?php echo $this->crud_model->get_course_thumbnail_url($course_details['id']); ?>" id="player" playsinline controls>
        ...
        <?php else: ?>
            <h4><?php echo youngo_frontend_phrase('video_url_is_not_supported'); ?></h4>
        <?php endif; ?>
    </video>
<?php endif; ?>
