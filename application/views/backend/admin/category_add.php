                ...
                <form class="required-form" action="<?php echo site_url('admin/categories/add'); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="border rounded p-3 mb-3">
                        ...
                        <div class="form-group mb-0">
                            ...
                            <input type="text" class="form-control" id="english_slug" name="english_slug" placeholder="<?php echo get_phrase('leave_blank_to_auto_generate'); ?>">
                        </div>
                    </div>
                    ...
                    <div class="border rounded p-3 mb-3">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="arabic_name" name="arabic_name" dir="rtl">
                        </div>
                        <div class="form-group mb-0">
                            <label for="arabic_slug"><?php echo get_phrase('slug'); ?></label>
                            <input type="text" class="form-control" id="arabic_slug" name="arabic_slug" dir="rtl" placeholder="<?php echo get_phrase('leave_blank_to_auto_generate'); ?>">
                        </div>
                    </div>
