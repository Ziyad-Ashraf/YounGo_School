...
<div class="border rounded p-3 mb-3">
    ...
    <div class="form-group mb-0">
        ...
        <textarea name="english_text_content" class="form-control" id="english_text_content" rows="4"><?php echo htmlspecialchars_decode_($youngo_lesson_english_text_content); ?></textarea>
    </div>
</div>
...
<div class="border rounded p-3 mb-3">
    ...
    <div class="form-group mb-0">
        ...
        <textarea name="arabic_text_content" class="form-control" id="arabic_text_content" rows="4" dir="rtl"><?php echo htmlspecialchars_decode_($youngo_lesson_arabic_text_content); ?></textarea>
    </div>
</div>
