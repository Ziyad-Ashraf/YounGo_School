<?php
    ...
    $can_manage_youngo_subscriptions = function_exists('youngo_user_has_capability')
        && youngo_user_has_capability($this->session->userdata('user_id'), 'manage_subscriptions');
    $can_grant_youngo_manual_access = function_exists('youngo_user_has_capability')
    ...
    $youngo_menu_active = in_array($page_name, array(
        ...
        'youngo_manual_grant_form',
        'youngo_manual_grant_view',
        'youngo_role_assignments',
        'youngo_payment_settings',
        'youngo_payment_test_center',
        'youngo_checkout_coupon_usage',
        'youngo_instapay_payments',
        'youngo_instapay_payment_view',
    ), true);
?>
<!-- ========== Left Sidebar Start ========== -->
...
?>">
            <a href="javascript: void(0);" class="side-nav-link<?php if ($youngo_menu_active): ?> active<?php endif; ?>">
...
?>">
                    <a href="<?php echo site_url('admin/youngo/subscription-plans'); ?>">Subscription Plans</a>
                </li>
                <?php endif; ?>
                <?php if ($can_grant_youngo_manual_access): ?>
                <li class="<?php if ($page_name == 'youngo_manual_grants' || $page_name == 'youngo_manual_grant_form' || $page_name == 'youngo_manual_grant_view') {
        echo 'active';
}
?>">
                    <a href="<?php echo site_url('admin/youngo/manual-grants'); ?>">Manual Grants</a>
                </li>
                <?php endif; ?>
                <?php if ($can_manage_youngo_roles): ?>
                <li class="<?php if ($page_name == 'youngo_role_assignments') {
        echo 'active';
}
?>">
                    <a href="<?php echo site_url('admin/youngo/role-assignments'); ?>">Role Assignments</a>
                </li>
                <?php endif; ?>
                <?php if ($can_view_youngo_payment_settings): ?>
                <li class="<?php if ($page_name == 'youngo_payment_settings' || $page_name == 'youngo_payment_test_center') {
        echo 'active';
}
?>">
                    <a href="<?php echo site_url('admin/youngo/payment-settings'); ?>">Payment Settings</a>
                </li>
                <li class="<?php if ($page_name == 'youngo_instapay_payments' || $page_name == 'youngo_instapay_payment_view') {
        echo 'active';
}
?>">
                    <a href="<?php echo site_url('admin/youngo/instapay-payments'); ?>">Instapay Payments</a>
                </li>
                <li class="<?php if ($page_name == 'youngo_checkout_coupon_usage') {
        echo 'active';
}
?>">
                    <a href="<?php echo site_url('admin/youngo/checkout-coupon-usage'); ?>">Coupon Checkout Usage</a>
                </li>
                <?php endif; ?>
            </ul>
        </li>
