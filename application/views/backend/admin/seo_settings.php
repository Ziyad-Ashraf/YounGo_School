                                        ...
                                        <div class="w-100">
                                            <form class="required-form" action="<?php echo site_url('admin/seo_settings/update/'.$seo_meta_tag['route']); ?>" method="post" enctype="multipart/form-data">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" id="meta_title" name="meta_title" type="text" value="<?php echo $seo_meta_tag['meta_title']; ?>" placeholder="<?php echo get_phrase('meta_title'); ?>" />
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" id="meta_description" name="meta_description" placeholder="<?php echo get_phrase('meta_description'); ?>" rows="3"><?php echo $seo_meta_tag['meta_description']; ?></textarea>
                                                </div>

                                                <div class="form-group">
                                                    <label for="meta_robot"><?php echo get_phrase('Meta Robot'); ?></label>
                                                    <input class="form-control" id="meta_robot" name="meta_robot" type="text" value="<?php echo $seo_meta_tag['meta_robot']; ?>" placeholder="<?php echo get_phrase('meta_robot'); ?>" />
                                                </div>
