	...
	<div class="col-md-12">
		<form class="ajaxForm" action="<?= site_url('admin/course_actions/add_shortcut'); ?>">
			...
			<div class="form-group">
				...
				<input type="text" name="english_title" class="form-control" placeholder="<?php echo get_phrase('enter_course_title'); ?>">
                <small class="text-muted">Shortcut creates canonical English course data and an English translation row. Complete Arabic content from the full course edit form.</small>
			</div>
			...
			<div class="form-group">
                ...
                <small class="text-muted">Course content marker only. Complete bilingual fields from the full course edit form.</small>
            </div>
