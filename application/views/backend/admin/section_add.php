<form action="<?php echo site_url('admin/sections/'.$param2.'/add'); ?>" method="post">
    <div class="border rounded p-3 mb-3">
        ...
        <div class="form-group mb-0">
            ...
            <input class="form-control" type="text" name="english_title" id="english_section_title" required>
    ...
    <div class="border rounded p-3 mb-3">
        ...
        <div class="form-group mb-0">
            ...
            <input class="form-control" type="text" name="arabic_title" id="arabic_section_title" dir="rtl">
        </div>
    </div>
