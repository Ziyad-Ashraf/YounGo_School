...
<form class="ajaxFormSubmission" action="<?php echo site_url('admin/lessons/'.$param2.'/add'); ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="border rounded p-3 mb-3">
        ...
        <div class="form-group">
            ...
            <input type="text" name="english_title" id="english_lesson_title" class="form-control" required>
        </div>

        <div class="form-group mb-0">
            <label for="english_lesson_summary"><?php echo get_phrase('summary'); ?></label>
            <textarea name="english_summary" id="english_lesson_summary" class="form-control"></textarea>
        </div>
    </div>
    ...
    <div class="border rounded p-3 mb-3">
        ...
        <div class="form-group">
            ...
            <input type="text" name="arabic_title" id="arabic_lesson_title" class="form-control" dir="rtl">
        </div>

        <div class="form-group mb-0">
            <label for="arabic_lesson_summary"><?php echo get_phrase('summary'); ?></label>
            <textarea name="arabic_summary" id="arabic_lesson_summary" class="form-control" dir="rtl"></textarea>
        </div>
    </div>
