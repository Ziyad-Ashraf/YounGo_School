...
<div class="mt-3">
    <div class="custom-control custom-radio">
        ...
        <label class="custom-control-label" for="youtube"><?php echo get_phrase('youtube'); ?> <?php echo get_phrase('video'); ?></label>
    </div>
    ...
    <div class="custom-control custom-radio">
        ...
        <label class="custom-control-label" for="vimeo"><?php echo get_phrase('vimeo'); ?> <?php echo get_phrase('video'); ?></label>
    </div>
    <div class="custom-control custom-radio">
    ...
    <?php if (addon_status('amazon-s3')): ?>
        <div class="custom-control custom-radio">
            ...
            <label class="custom-control-label" for="amazon-s3"><?php echo get_phrase('amazon_s3_bucket'); ?></label>
        </div>
    <?php endif;?>
    ...
    <?php if (addon_status('wasabi-s3')): ?>
        <div class="custom-control custom-radio">
            ...
            <label class="custom-control-label" for="wasabi-s3"><?php echo get_phrase('wasabi_s3_bucket'); ?></label>
        </div>
    <?php endif;?>
