...
<div class="row">
    ...
    <div class="col-md-5">
        ...
        <div class="card" data-youngo-paymob-legacy-link="true">
            <div class="card-body">
                <h4 class="header-title"><p><?php echo get_phrase('youngo_paymob_setup'); ?></p></h4>
                <p class="text-muted">
                    YounGo Paymob uses a dedicated checkout and readiness flow separate from the legacy Academy payment gateways on this page.
                </p>
                <p class="text-muted">
                    Use the YounGo Paymob page for sandbox setup, readiness checks, and redacted configuration status. This link does not add Paymob to legacy gateway rows or enable legacy payment behavior.
                </p>
                <a class="btn btn-outline-primary btn-sm" href="<?php echo site_url('admin/youngo/payment-settings'); ?>">
                    Open YounGo Paymob Settings
                </a>
            </div>
        </div>
    </div>
