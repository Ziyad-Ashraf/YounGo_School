    ...
    <div class="col-md-10">
    	<div class="card">
    		<div class="card-body">
                ...
                <?php
                $youngo_blog_english_translation = isset($youngo_blog_english_translation) && is_array($youngo_blog_english_translation) ? $youngo_blog_english_translation : array();
                $youngo_blog_arabic_translation = isset($youngo_blog_arabic_translation) && is_array($youngo_blog_arabic_translation) ? $youngo_blog_arabic_translation : array();
                ?>
		    	<form action="<?php echo site_url('admin/blog/update/'.$blog['blog_id']); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="english_excerpt"><?php echo get_phrase('english_excerpt'); ?></label>
                        <textarea class="form-control" name="english_excerpt" id="english_excerpt" rows="2" maxlength="500" placeholder="<?php echo get_phrase('short_summary_for_blog_cards'); ?>"><?php echo htmlspecialchars(isset($youngo_blog_english_translation['excerpt']) ? $youngo_blog_english_translation['excerpt'] : '', ENT_QUOTES, 'UTF-8'); ?></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="arabic_title"><?php echo get_phrase('arabic_title'); ?></label>
                        <input type="text" class="form-control" name="arabic_title" id="arabic_title" value="<?php echo htmlspecialchars(isset($youngo_blog_arabic_translation['title']) ? $youngo_blog_arabic_translation['title'] : '', ENT_QUOTES, 'UTF-8'); ?>" dir="rtl" lang="ar">
                    </div>

                    <div class="form-group">
                        <label for="arabic_excerpt"><?php echo get_phrase('arabic_excerpt'); ?></label>
                        <textarea class="form-control" name="arabic_excerpt" id="arabic_excerpt" rows="2" maxlength="500" dir="rtl" lang="ar"><?php echo htmlspecialchars(isset($youngo_blog_arabic_translation['excerpt']) ? $youngo_blog_arabic_translation['excerpt'] : '', ENT_QUOTES, 'UTF-8'); ?></textarea>
                    </div>

                    <div class="form-group">
                        <label for="arabic_description"><?php echo get_phrase('arabic_description'); ?></label>
                        <textarea class="form-control" name="arabic_description" id="arabic_description" rows="6" dir="rtl" lang="ar"><?php echo isset($youngo_blog_arabic_translation['description']) ? htmlspecialchars_decode_($youngo_blog_arabic_translation['description']) : ''; ?></textarea>
                    </div>
