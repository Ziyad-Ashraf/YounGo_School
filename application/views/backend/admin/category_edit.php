...
$english_translation = $this->youngo_translation_model->get_category_translation_with_fallback($category_id, 'english');
$arabic_translation  = $this->youngo_translation_model->get_category_translation($category_id, 'arabic');
$english_name = !empty($english_translation['name']) ? $english_translation['name'] : $category_details['name'];
$english_slug = isset($english_translation['slug']) && $english_translation['slug'] !== '' ? $english_translation['slug'] : $category_details['slug'];
        ...
        <div class="col-lg-12">
          ...
          <form class="required-form" action="<?php echo site_url('admin/categories/edit/'.$category_id); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="border rounded p-3 mb-3">
              ...
              <div class="form-group">
                <label for="english_name"><?php echo get_phrase('category_title'); ?><span class="required">*</span></label>
                <input type="text" class="form-control" id="english_name" name="english_name" value="<?php echo html_escape($english_name); ?>" required>
              </div>
              <div class="form-group mb-0">
                <label for="english_slug"><?php echo get_phrase('slug'); ?></label>
                <input type="text" class="form-control" id="english_slug" name="english_slug" value="<?php echo html_escape($english_slug); ?>" placeholder="<?php echo get_phrase('leave_blank_to_auto_generate'); ?>">
              </div>
            </div>
            ...
            <div class="border rounded p-3 mb-3">
              ...
              <div class="form-group">
                <label for="arabic_name"><?php echo get_phrase('category_title'); ?></label>
                <input type="text" class="form-control" id="arabic_name" name="arabic_name" value="<?php echo html_escape($arabic_name); ?>" dir="rtl">
              </div>
              <div class="form-group mb-0">
                <label for="arabic_slug"><?php echo get_phrase('slug'); ?></label>
                <input type="text" class="form-control" id="arabic_slug" name="arabic_slug" value="<?php echo html_escape($arabic_slug); ?>" dir="rtl" placeholder="<?php echo get_phrase('leave_blank_to_auto_generate'); ?>">
              </div>
            </div>
