              ...
              <div class="table-responsive">
                <table class="table table-centered w-100 dt-responsive nowrap" id="products-datatable">
                  <thead class="thead-light">
                      <tr>
                          <th class="all" style="background-color: #f9f9f9; border-color: #ffffff;"><?php echo get_phrase('product'); ?></th>
                          <th style="background-color: #f9f9f9; border-color: #ffffff;"><?php echo get_phrase('price'); ?></th>
                          <th style="background-color: #f9f9f9; border-color: #ffffff; width: 85px;"><?php echo get_phrase('action'); ?></th>
                      </tr>
                  </thead>
                  <tbody>
                    <?php foreach($items as $item):
                      ...
                      <tr>
                            ...
                            <p class="m-0 d-inline-block align-middle font-16">
                                <a target="_blank" href="<?php echo $item['url']; ?>" class="text-body">
                                  <?php
                                    echo $item['name'];
                                    if($item['id'] == '22703468'){
                                      echo ' | <span class="badge badge-primary"><?php echo get_phrase('main_product'); ?></span>';
                                    }
                                  ?>
                                </a>
                                <br/>
                        ...
                        <td class="table-action">
                          <a href="<?php echo $item['url']; ?>" data-toggle="tooltip" title="<?php echo get_phrase('buy_now'); ?>" class="action-icon" target="_blank"><i class="mdi mdi-cart-outline"></i></a>
                          <a href="<?php echo $demo_url; ?>" data-toggle="tooltip" title="<?php echo get_phrase('watch_demo'); ?>" class="action-icon" target="_blank"><i class="mdi mdi-open-in-new"></i></a>
                        </td>
                      </tr>
                    <?php endforeach; ?>
                  </tbody>
