    		...
    		<div class="card-body">
		    	...
		    	<form action="<?php echo site_url('admin/blog/add'); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="english_excerpt" id="english_excerpt" rows="2" maxlength="500" placeholder="<?php echo get_phrase('short_summary_for_blog_cards'); ?>"></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="arabic_title" id="arabic_title" dir="rtl" lang="ar">
                    </div>

                    <div class="form-group">
                        <label for="arabic_excerpt"><?php echo get_phrase('arabic_excerpt'); ?></label>
                        <textarea class="form-control" name="arabic_excerpt" id="arabic_excerpt" rows="2" maxlength="500" dir="rtl" lang="ar"></textarea>
                    </div>

                    <div class="form-group">
                        <label for="arabic_description"><?php echo get_phrase('arabic_description'); ?></label>
                        <textarea class="form-control" name="arabic_description" id="arabic_description" rows="6" dir="rtl" lang="ar"></textarea>
                    </div>
