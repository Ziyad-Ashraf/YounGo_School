                    ...
                    <form action="<?php echo site_url('admin/categories/add'); ?>" method="post" role="form" class="form-horizontal form-groups-bordered">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" name="english_slug" class="form-control" placeholder="<?php echo get_phrase('leave_blank_to_auto_generate'); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" name="arabic_slug" class="form-control" dir="rtl" placeholder="<?php echo get_phrase('leave_blank_to_auto_generate'); ?>">
                                </div>
                            </div>
