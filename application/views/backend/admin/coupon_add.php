                ...
                <div class="col-lg-12">
                    ...
                    <form class="required-form" action="<?php echo site_url('admin/coupons/add'); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="start_date" class="form-control date" id="start_date" data-toggle="date-picker" data-single-date-picker="true" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="status" name="status"><option value="active">Active</option><option value="inactive">Inactive</option></select>
                        </div>
