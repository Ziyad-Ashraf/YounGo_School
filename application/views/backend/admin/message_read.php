...
<div class="row">
	<div class="col-sm-12 col-md-12 col-lg-12">
	    ...
	    <div class="card">
	        <div class="card-body">
	            <h4 class="header-title mb-3"><?php echo get_phrase('chat'); ?></h4>
	            ...
	            <div class="chat-conversation">
	                ...
	                <form method="post" action="<?php echo site_url('admin/message/send_reply/'.$current_message_thread_code); ?>" class="needs-validation" novalidate name="chat-form" id="chat-form">
	                    <div class="row">
	                        <div class="col">
	                            <input type="text" name="message" class="form-control chat-input" placeholder="<?php echo get_phrase('enter_your_text'); ?>" required>
