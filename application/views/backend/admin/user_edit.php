<?php
    ...
    $social_links = array_merge(array('facebook' => '', 'twitter' => '', 'linkedin' => ''), $social_links);
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <?php if (!empty($can_view_youngo_entitlement_summary) && !empty($youngo_user_entitlement_summary)): ?>
                    <?php $this->load->view('backend/admin/youngo_user_entitlement_summary'); ?>
                <?php endif; ?>
                        ...
                        <div class="tab-content b-0 mb-0">
                            ...
                            <ul class="list-inline mb-0 wizard">
                                <li class="previous list-inline-item">
                                    <a href="javascript:;" class="btn btn-info"><?php echo get_phrase('previous'); ?></a>
                                </li>
                                <li class="next list-inline-item float-right">
                                    <a href="javascript:;" class="btn btn-info"><?php echo get_phrase('next'); ?></a>
                                </li>
                            </ul>
