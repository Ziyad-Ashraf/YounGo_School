...
<div class="row">
  ...
  <div class="col-md-4">
    <div class="alert alert-warning" role="alert">
      ...
      <p><?php echo get_phrase('just_configure_the_payment_gateway_you_want_to_use,_leave_the_rest_blank.'); ?></p>
      <hr>
      <p><?php echo get_phrase('also,_make_sure_that_you_have_configured_your_payment_settings_correctly'); ?></p>
    </div>
  </div>
</div>
