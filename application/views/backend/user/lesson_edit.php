...
$youngo_lesson_english = is_array($youngo_lesson_english_translation) ? $youngo_lesson_english_translation : array();
$youngo_lesson_arabic = is_array($youngo_lesson_arabic_translation) ? $youngo_lesson_arabic_translation : array();
$youngo_lesson_english_title = !empty($youngo_lesson_english['title']) ? $youngo_lesson_english['title'] : $lesson_details['title'];
...
$youngo_lesson_english_text_content = !empty($youngo_lesson_english['text_content']) ? $youngo_lesson_english['text_content'] : $lesson_details['attachment'];
