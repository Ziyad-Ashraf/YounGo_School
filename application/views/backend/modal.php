        ...
        <div class="modal-content">
            <div class="modal-body p-4">
                <div class="text-center">
                    ...
                    <h4 class="mt-2"><?php echo get_phrase("heads_up"); ?>!</h4>
                    <p class="mt-3"><?php echo get_phrase('i_understand_that_existing_website_data_will_be_replaced_by_new_data._current_website_data_will_be_preserved_as_backup_for_further_restoration.'); ?></p>
  ...
  <div class="modal-dialog modal-lg modal-right">
    <div class="modal-content h-100">
      <div class="modal-header border-1">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
        <h4 class="modal-title"><?php echo get_phrase('create_admin'); ?></h4>
      </div>
