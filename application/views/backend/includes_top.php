...
<?php $admin_html_dir = isset($admin_html_dir) ? $admin_html_dir : 'ltr'; ?>
<link rel="stylesheet" href="<?php echo base_url() . 'assets/frontend/default-new/css/' . ($admin_html_dir === 'rtl' ? 'bootstrap.rtl.min.css' : 'bootstrap.min.css'); ?>">
...
<?php if ($admin_html_dir === 'rtl') : ?>
<link href="<?php echo base_url('assets/backend/css/rtl.css'); ?>" rel="stylesheet" type="text/css" />
<?php endif; ?>
