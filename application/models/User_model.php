...
class User_model extends CI_Model
{
    ...
    private function youngo_public_auth_language()
    {
        $language = $this->session->userdata('youngo_public_auth_language');
    ...
    private function youngo_public_auth_url($uri_string = '')
    {
        if (file_exists(APPPATH . 'helpers/youngo_frontend_language_helper.php')) {
            ...
            if (function_exists('youngo_frontend_public_url')) {
                return youngo_frontend_public_url($uri_string, $this->youngo_public_auth_language());
            }
        }
...
/*START LOGIN LOGOUT AND DEVICE ALLOW SECTION*/
    ...
    function set_login_userdata($user_id = ""){
        ...
        if ($query->num_rows() > 0) {
            ...
            if ($row->role_id == 1) {
                ...
                redirect($this->youngo_public_auth_url(''), 'refresh');
            }
        } else {
    ...
    function check_session_data($user_type = ""){
        ...
        if($user_type == 'admin'){
            ...
            if ($this->session->userdata('admin_login')) {
                ...
                redirect($this->youngo_public_auth_url('home/my_courses'), 'refresh');
            }
        }
    }
    ...
    public function session_destroy()
    {
        ...
        $this->session->unset_userdata('youngo_public_auth_language');
